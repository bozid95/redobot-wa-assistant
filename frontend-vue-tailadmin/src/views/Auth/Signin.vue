        ...
        <div class="flex w-full flex-1 flex-col lg:w-1/2">
          ...
          <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
            <div class="mb-5 sm:mb-8">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">Gunakan akun admin untuk masuk.</p>
            </div>
        ...
        <div class="relative hidden h-full w-full items-center bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
          <div class="z-1 flex items-center justify-center">
            ...
            <div class="flex max-w-xs flex-col items-center">
              ...
              <p class="text-center text-gray-400 dark:text-white/60">redobot WA Asisten admin workspace</p>
            </div>
          </div>
        </div>
      </div>
